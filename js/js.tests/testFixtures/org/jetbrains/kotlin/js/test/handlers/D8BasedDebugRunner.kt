                        ...
                        for (const [name, value] of Object.entries(obj)) {
                            ...
                            if(isWasmObject) {
                                ...
                                if(!("type" in localsEntry) && !("value" in localsEntry)) {
                                    ...
                                    // TODO(REVIEW): if I understand JS correctly, null never has a user-defined type, so hardcoding "object" here if no type is supplied makes the most sense?
    ...
    private inner class FrameParser(private val input: String) {
        fun JsonObject.toLocalsRecord(name: String): LocalVariableRecord {
            ...
            val value: LocalValue = when ((properties["kind"] as JsonString).value) {
                ...
                // TODO(REVIEW): better exception to throw here?
                ...
                .map { frameObject ->
                    ...
                    val locals = if (!includeLocalVariableInformation) {
                        ...
                        if (localsProps.containsKey(jsLocalsErrorKey)) {
                            // TODO(REVIEW): better error function to call/exception to throw here?
                        ...
                        // TODO(REVIEW): We do want to filter out internals, right? (this includes e.g. hidden loop induction variables)
