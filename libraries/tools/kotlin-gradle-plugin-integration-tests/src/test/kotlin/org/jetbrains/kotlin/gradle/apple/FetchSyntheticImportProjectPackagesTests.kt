        ...
        project("empty", version) {
            withLockFileFixture {
                ...
                build(
                    ...
                    val rootSyntheticPackageHash = projectPath.resolve("build/kotlin/syntheticPackageHash").readText().trim()

                    val syntheticPackage = projectPath.resolve("build/kotlin/swiftSyntheticPackages").resolve(rootSyntheticPackageHash)
                        .resolve("Package.resolved")
                    val sharedCheckoutDir = projectPath.resolve("build/kotlin/swiftPMCheckouts").resolve(rootSyntheticPackageHash)
            ...
            withLockFileFixture {
                ...
                build(
                    ...
                    val consumerSyntheticPackageHash =
                        kmpMapsConsumer.projectPath.resolve("build/kotlin/syntheticPackageHash").readText().trim()
                    ...
                    val rootSyntheticPackageResolved =
                        projectPath.resolve("build/kotlin/swiftSyntheticPackages").resolve(rootSyntheticPackageHash)
                            .resolve("Package.resolved")
                    ...
                    val rootCheckoutDirWorkspaceState =
                        projectPath.resolve("build/kotlin/swiftPMCheckouts").resolve(rootSyntheticPackageHash)
                            .resolve("workspace-state.json")
                    ...
                    val consumerSyntheticPackageResolved =
                        projectPath.resolve("build/kotlin/swiftSyntheticPackages").resolve(consumerSyntheticPackageHash)
                            .resolve("Package.resolved")
                    ...
                    val consumerCheckoutDirWorkspaceState =
                        projectPath.resolve("build/kotlin/swiftPMCheckouts").resolve(consumerSyntheticPackageHash)
                            .resolve("workspace-state.json")
