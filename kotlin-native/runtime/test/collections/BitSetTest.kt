...
class BitSetTest {
    @Test fun constructor() {
        var b = BitSet(12)
        assertContainsOnly(b, [], 12)

        b = BitSet(12) { it == 0 || it in 5..6 || it == 11 }
        assertContainsOnly(b, [0, 5, 6, 11], 12)
    }
    ...
    @Test fun set() {
        ...
        assertContainsOnly(b, [0, 3], 4)
        b.clear()
        assertContainsOnly(b, [], 4)
        b.set(1)
        b.set(5)
        assertEquals(b.lastTrueIndex, 5)
        assertContainsOnly(b, [1, 5], 6)
        b.set(1, false)
        b.set(7, false)
        assertEquals(b.lastTrueIndex, 5)
        assertContainsOnly(b, [5], 8)
        b.clear(5)
        assertEquals(b.lastTrueIndex, -1)
        assertContainsOnly(b, [], 8)
        b.set(70)
        assertEquals(b.lastTrueIndex, 70)
        assertContainsOnly(b, [70], 71)
        b.clear(70)
        assertEquals(b.lastTrueIndex, -1)
        assertContainsOnly(b, [], 71)

        // Test set and clear operations for ranges.
        // Set false and clear.
        b = BitSet(2)
        assertContainsOnly(b, [], 2)
        b.set(0..70, true)
        assertNotContainsOnly(b, [], 71)
        b.set(0..2, false)
        assertNotContainsOnly(b, [0, 1, 2], 71)
        b.set(63..65, false)
        assertNotContainsOnly(b, [0, 1, 2, 63, 64, 65], 71)
        b.set(68..70, false)
        assertNotContainsOnly(b, [0, 1, 2, 63, 64, 65, 68, 69, 70], 71)
        b.set(68..72, false)
        assertNotContainsOnly(b, [0, 1, 2, 63, 64, 65, 68, 69, 70, 71, 72], 73)
        b.set(0..72, false)
        assertContainsOnly(b, [], 73)

        b.set(0..72)
        assertNotContainsOnly(b, [], 73)
        b.clear(0..2)
        assertNotContainsOnly(b, [0, 1, 2], 73)
        b.clear(63..65)
        assertNotContainsOnly(b, [0, 1, 2, 63, 64, 65], 73)
        b.clear(68..70)
        assertNotContainsOnly(b, [0, 1, 2, 63, 64, 65, 68, 69, 70], 73)
        b.clear(68..72)
        assertNotContainsOnly(b, [0, 1, 2, 63, 64, 65, 68, 69, 70, 71, 72], 73)
        b.clear(0..72)
        assertContainsOnly(b, [], 73)
        ...
        // Set true.
        b.set(0..2, true)
        assertContainsOnly(b, [0, 1, 2], 73)
        b.set(63..65, true)
        assertContainsOnly(b, [0, 1, 2, 63, 64, 65], 73)
        b.set(70..72, true)
        assertContainsOnly(b, [0, 1, 2, 63, 64, 65, 70, 71, 72], 73)
        b.set(73..74, true)
        assertContainsOnly(b, [0, 1, 2, 63, 64, 65, 70, 71, 72, 73, 74], 75)
        b.set(0..74, true)
        assertNotContainsOnly(b, [], 75)
    ...
    @Test fun flip() {
        ...
        assertEquals(b.lastTrueIndex, 70)
        // 0 element
        assertContainsOnly(b, [0, 63, 64, 65, 70], 71)
        b.flip(0)
        assertContainsOnly(b, [63, 64, 65, 70], 71)
        b.flip(1)
        assertContainsOnly(b, [1, 63, 64, 65, 70], 71)
        b.flip(0)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 70], 71)

        // last element
        b.flip(70)
        assertContainsOnly(b, [0, 1, 63, 64, 65], 71)
        b.flip(69)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 69], 71)
        b.flip(70)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 69, 70], 71)

        // element in the middle
        b.flip(64)
        assertContainsOnly(b, [0, 1, 63, 65, 69, 70], 71)
        b.flip(65)
        assertContainsOnly(b, [0, 1, 63, 69, 70], 71)
        b.flip(65)
        b.flip(64)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 69, 70], 71)
        ...
        b.flip(0..2)
        assertContainsOnly(b, [2, 63, 64, 65, 69, 70], 71)
        b.flip(0, 3)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 69, 70], 71)

        // In the end
        b.flip(68..70)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 68], 71)
        b.flip(68, 71)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 69, 70], 71)

        // In the middle
        b.flip(64..66)
        assertContainsOnly(b, [0, 1, 63, 66, 69, 70], 71)
        b.flip(64, 67)
        assertContainsOnly(b, [0, 1, 63, 64, 65, 69, 70], 71)
    ...
    @Test fun logic() {
        ...
        b1.and(b2)
        assertContainsOnly(b1, [3, 63, 67, 72], 76)
        b1 = BitSet(73)
        b1.set(2..3); b1.set(62..63); b1.set(66..67); b1.set(71..72)
        b1.set(128)
        b1.and(b2)
        assertContainsOnly(b1, [3, 63, 67, 72], 129)

        // or
        b1 = BitSet(73)
        b1.set(2..3); b1.set(62..63); b1.set(66..67); b1.set(71..72)
        b1.or(b2)
        assertContainsOnly(b1, [1, 2, 3, 61, 62, 63, 65, 66, 67, 70, 71, 72], 76)

        b1 = BitSet(73)
        b1.set(2..3); b1.set(62..63); b1.set(66..67); b1.set(71..72)
        b1.set(128)
        b1.or(b2)
        assertContainsOnly(b1, [1, 2, 3, 61, 62, 63, 65, 66, 67, 70, 71, 72, 128], 129)

        // xor
        b1 = BitSet(73)
        b1.set(2..3); b1.set(62..63); b1.set(66..67); b1.set(71..72)
        b1.xor(b2)
        assertContainsOnly(b1, [1, 2, 61, 62, 65, 66, 70, 71], 76)

        b1 = BitSet(73)
        b1.set(2..3); b1.set(62..63); b1.set(66..67); b1.set(71..72)
        b1.set(128)
        b1.xor(b2)
        assertContainsOnly(b1, [1, 2, 61, 62, 65, 66, 70, 71, 128], 129)

        // andNot
        b1 = BitSet(73)
        b1.set(2..3); b1.set(62..63); b1.set(66..67); b1.set(71..72)
        b1.andNot(b2)
        assertContainsOnly(b1, [2, 62, 66, 71], 76)

        b1 = BitSet(73)
        b1.set(2..3); b1.set(62..63); b1.set(66..67); b1.set(71..72)
        b1.set(128)
        b1.andNot(b2)
        assertContainsOnly(b1, [2, 62, 66, 71, 128], 129)
