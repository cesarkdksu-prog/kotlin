...
abstract class IrModuleDeserializer(
    ...
    open fun getAllMatchedSignatures(callableId: CallableId, signatureKind: IrDeserializer.TopLevelSymbolKind): List<IdSignature> {
        return this.fileDeserializers().flatMap {
            it.getAllMatchedSignatures(callableId, signatureKind)
        }
    }
}
...
//        assert(builtIns.builtIns.builtInsModule === delegate.moduleDescriptor)
    ...
    override fun getAllMatchedSignatures(callableId: CallableId, signatureKind: IrDeserializer.TopLevelSymbolKind): List<IdSignature> {
        ...
        return super.getAllMatchedSignatures(callableId, signatureKind)
    }
}
